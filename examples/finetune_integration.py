...
hyperparameter_defaults = dict(
    ...
    mask_ratio=0.4, # the ratio of genes to be masked
    epochs=30, # the number of training cycles
    n_bins=51, # the number of bins to use for expression binning
    GEPC=True,  # Masked value prediction for cell embedding
    ecs_thres=0.8,  # Elastic cell similarity objective, 0.0 to 1.0, 0.0 to disable
    dab_weight=1.0, # weight for domain adversarial loss
    lr=1e-4, # learning rate
    batch_size=64, # number of cells per batch
    layer_size=128, # dimension of transformer layers
